...
def avg_std_time_delivery( df1, festival, op):                
    """
        Esta função calcula o tempo médo e o desvio padrão do tempo de entrega.
        Parâmetros:
            Imput:
                - df: Dataframe com os dados necessários para o cálculo
                - op: Tipo de operação que precisa ser calculado
                    'avg_time': Calcula o tempo médio
                    'stf_time': Calcula o desvio padrão do tempo.
            Output:
...
def distance( df1 ):               
    ...
    df1['distance'] = ( df1.loc[:, cols].apply( lambda x: haversine( (x['Restaurant_latitude'],
        x['Restaurant_longitude']),(x['Delivery_location_latitude'],x['Delivery_location_longitude'])), axis=1) )
